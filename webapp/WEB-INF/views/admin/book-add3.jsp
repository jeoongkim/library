...
<body>
	...
	<div class="container">
	<h1>오디오북 추가</h1>
	<form action="<c:url value='/admin/book-add3.do'/>" method="post" enctype="multipart/form-data">
		
		<div>
			<label>isbn: ${ isbn }</label>
		</div>
		<div>
			<label>출판일<input type="date" name="publicationDay"></label>
		</div>
		<div>
			<label>입고일<input type="date" name="wearingDay"></label>
		</div>
