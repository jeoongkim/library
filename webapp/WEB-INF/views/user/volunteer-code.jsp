...
<body>
	...
	<br><br><h1 align="center" >비밀번호를 입력하세요.</h1><br><br>
	<div class="container">
	
	<form action="<c:url value='/user/volunteer-detail.do'/>" method="post">
		...
		<input type="hidden" name="volunNo" id="volunNo" value="${ volun.volunNo }">
